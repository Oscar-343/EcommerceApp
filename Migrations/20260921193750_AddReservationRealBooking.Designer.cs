...
namespace EcommerceApp.Migrations
{
    ...
    [Migration("20260921193750_AddReservationRealBooking")]
    partial class AddReservationRealBooking
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceApp.Models.Guide", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceApp.Models.Reservation", b =>
                {
                    ...
                    b.HasIndex("UserId", "ServiceId", "TripDate")
                        .IsUnique();

                    b.ToTable("Reservations");
                });

            modelBuilder.Entity("EcommerceApp.Models.Service", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceApp.Models.ServiceProduct", b =>
                {
                    b.Property<int>("ServiceId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceApp.Models.Transport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("EcommerceApp.Models.Reservation", b =>
                {
                    b.HasOne("EcommerceApp.Models.Service", "Service")
                        .WithMany()
            ...
            modelBuilder.Entity("EcommerceApp.Models.Service", b =>
                {
                    b.HasOne("EcommerceApp.Models.Guide", "Guide")
                        .WithMany()
                        .HasForeignKey("GuideId");

                    b.HasOne("EcommerceApp.Models.Transport", "Transport")
                        .WithMany()
